...
1. `docs/specs/SKILLS_API.md` — one derive → five artifacts; S6 surface counts.
2. `docs/specs/HEALTH.md` — one plane (Sylk ran four); no authority.
3. `docs/specs/FOREST.md` — Z-set field engine, ACT-R/FSRS/MMAS/Parunak/PPR

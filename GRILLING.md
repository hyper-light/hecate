...
1. `docs/specs/REGISTRY.md` v2 — syllium-informed; ref-CAS sole mutation; watch
   API; schema-doc kinds; §4b materialization path.
2. `docs/specs/SKILLS_API.md` — one derive → five artifacts; S6 surface counts.
3. `docs/specs/HEALTH.md` — one plane (Sylk ran four); no authority.
4. `docs/specs/FOREST.md` — Z-set field engine, ACT-R/FSRS/MMAS/Parunak/PPR
